...
class BankService:
    ...
    def get_transactions(self):
        ...
        for transaction in database["transactions"]:
            if self.__current_user.id == transaction.from_id:
                print(transaction)
...
database = {
    "users": [
        ...
        User(str(uuid4()), "second", "123", datetime(1999, 10, 10)),
        User(str(uuid4()), "third", "123", datetime(1999, 10, 10)),
        User(str(uuid4()), "fourth", "123", datetime(1999, 10, 10)),
    ],
    "wallets": [
        Wallet(owner_id="1", balance=5000000),
        Wallet(owner_id="2"),
    ],
    "transactions": [],
}
